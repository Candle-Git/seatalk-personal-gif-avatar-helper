...
1. Send a GIF through SeaTalk's sticker button in the current chat. Do not upload it as a regular image file.
2. Open the helper and capture recent GIFs from this chat.
